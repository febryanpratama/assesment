                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            @role('Owner')
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link" href="{{ url('owner') }}">
                                    Owner Only
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link" href="{{ route('roles.index') }}">
                                    Role Menu
                                </a>
                            </li>
                            <li class="nav-item dropdown">
                            ...
                            @role('Staff')
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link" href="{{ url('staff') }}">
                                    Staff Only
                                </a>
                            </li>
                            <li class="nav-item dropdown">
